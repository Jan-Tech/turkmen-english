...
export default function PreIntLessonPage() {
  ...
  async function markComplete() {
    ...
    if (lesson.nextLessonSlug) {
      router.push(`/pre-intermediate/units/${unitSlug}/lessons/${lesson.nextLessonSlug}`);
    } else {
      router.push(`/pre-intermediate/units/${unitSlug}`);
    }
  }
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        <Breadcrumb items={[
          ...
          { label: lesson.unitTitle, href: `/pre-intermediate/units/${unitSlug}` },
