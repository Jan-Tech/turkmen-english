...
export default function IntermediateLessonPage() {
  ...
  async function markComplete() {
    ...
    if (lesson.nextLessonSlug) {
      router.push(`/intermediate/units/${unitSlug}/lessons/${lesson.nextLessonSlug}`);
    } else {
      router.push(`/intermediate/units/${unitSlug}`);
    }
  }
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        <Breadcrumb items={[
          ...
          { label: lesson.unitTitle, href: `/intermediate/units/${unitSlug}` },
