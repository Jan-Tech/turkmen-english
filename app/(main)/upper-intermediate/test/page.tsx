...
export default async function UpperIntermediateTestPage() {
  ...
  return (
    <div className="space-y-4">
      <Link href="/upper-intermediate" className="text-sm text-gray-500 hover:text-gray-700">← Ýokary Orta</Link>
      <QuizContainer questions={questions} bigTestId={level.bigTest.id} title={level.bigTest.titleTk} backHref="/upper-intermediate" />
    </div>
  );
}
